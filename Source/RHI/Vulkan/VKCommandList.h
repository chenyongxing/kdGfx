...
namespace kdGfx
{
    ...
    public:
        ...
        void setVertexBuffer(uint32_t slot, const std::shared_ptr<Buffer>& buffer) override;
        void setIndexBuffer(const std::shared_ptr<Buffer>& buffer, Format indexForamt) override;
