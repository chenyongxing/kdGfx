...
namespace kdGfx
{
    ...
    public:
        ...
        virtual void setVertexBuffer(uint32_t slot, const std::shared_ptr<Buffer>& buffer) = 0;
        virtual void setIndexBuffer(const std::shared_ptr<Buffer>& buffer, Format indexForamt = Format::R32Uint) = 0;
